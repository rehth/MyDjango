    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.SmallIntegerField(choices=[(1, '上架'), (2, '下架')], default=0, verbose_name='状态')),
            ],
            options={
                'db_table': 'goods_sku',
                'verbose_name': '商品',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detail', tinymce.models.HTMLField(null=True, verbose_name='商品详情', blank=True)),
            ],
            options={
                'db_table': 'goods_spu',
                'verbose_name': '商品SPU',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('index', models.SmallIntegerField(default=0, verbose_name='展示顺序')),
                ('goods', models.ForeignKey(to='goods.GoodsType', verbose_name='商品类型')),
